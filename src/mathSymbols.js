...
export const mathSymbols = [
  ...
  // ── Math ────────────────────────────────────────────────────────────
  { code: "pm",             aliases: ["plusminus"],                   symbol: "±", name: "Plus minus",                          category: "Basic Math",                         rank: 1 },
  { code: "mp",             aliases: ["minusplus"],                   symbol: "∓", name: "Minus plus",                          category: "Basic Math",                         rank: 2 },
  { code: "infty",          aliases: ["infinity", "inf"],             symbol: "∞", name: "Infinity",                            category: "Basic Math",                         rank: 1 },
  { code: "neq",            aliases: ["ne", "notequal"],              symbol: "≠", name: "Not equal to",                        category: "Basic Math",                         rank: 1 },
  { code: "sim",            aliases: [],                              symbol: "∼", name: "Approximately (similar to)",           category: "Basic Math",                         rank: 2 },
  { code: "times",          aliases: [],                              symbol: "×", name: "Multiplication sign",                 category: "Basic Math",                         rank: 1 },
  { code: "div",            aliases: ["divide"],                      symbol: "÷", name: "Division sign",                       category: "Basic Math",                         rank: 2 },
  { code: "propto",         aliases: ["proportional"],                symbol: "∝", name: "Proportional to",                    category: "Basic Math",                         rank: 2 },
  { code: "ll",             aliases: ["muchless"],                    symbol: "≪", name: "Much less than",                      category: "Basic Math",                         rank: 2 },
  { code: "gg",             aliases: ["muchgreater"],                 symbol: "≫", name: "Much greater than",                   category: "Basic Math",                         rank: 2 },
  { code: "leq",            aliases: ["le", "lte"],                   symbol: "≤", name: "Less than or equal to",               category: "Basic Math",                         rank: 1 },
  { code: "geq",            aliases: ["ge", "gte"],                   symbol: "≥", name: "Greater than or equal to",            category: "Basic Math",                         rank: 1 },
  { code: "cong",           aliases: ["congruent"],                   symbol: "≅", name: "Approximately equal to",              category: "Basic Math",                         rank: 2 },
  { code: "approx",         aliases: ["app"],                         symbol: "≈", name: "Almost equal to",                     category: "Basic Math",                         rank: 1 },
  { code: "equiv",          aliases: ["identical"],                   symbol: "≡", name: "Identical to",                        category: "Basic Math",                         rank: 2 },
  { code: "forall",         aliases: ["foreach", "all"],              symbol: "∀", name: "For all",                             category: "Basic Math",                         rank: 2 },
  { code: "complement",     aliases: ["compl"],                       symbol: "∁", name: "Set complement",                      category: "Basic Math",                         rank: 3 },
  { code: "partial",        aliases: [],                              symbol: "∂", name: "Partial differential",                category: "Basic Math",                         rank: 1 },
  { code: "sqrt",           aliases: ["2root"],                       symbol: "√", name: "Radical sign",                        category: "Basic Math",                         rank: 1 },
  { code: "cbrt",           aliases: ["3root"],                       symbol: "∛", name: "Cube root",                           category: "Basic Math",                         rank: 2 },
  { code: "qdrt",           aliases: ["4root"],                       symbol: "∜", name: "Fourth root",                         category: "Basic Math",                         rank: 3 },
  { code: "emptyset",       aliases: ["empty", "null"],               symbol: "∅", name: "Empty set",                           category: "Basic Math",                         rank: 2 },
  { code: "deg",            aliases: ["degree"],                      symbol: "°", name: "Degrees",                             category: "Basic Math",                         rank: 1 },
  { code: "rad",            aliases: [],                              symbol: "㎭", name: "Radians",                             category: "Basic Math",                         rank: 2 },
  { code: "degf",           aliases: [],                              symbol: "℉", name: "Degrees Fahrenheit",                  category: "Basic Math",                         rank: 2 },
  { code: "degc",           aliases: [],                              symbol: "℃", name: "Degrees Celsius",                     category: "Basic Math",                         rank: 2 },
  { code: "inc",            aliases: ["laplace"],                     symbol: "∆", name: "Increment",                           category: "Basic Math",                         rank: 2 },
  { code: "nabla",          aliases: ["grad"],                        symbol: "∇", name: "Nabla / Gradient",                    category: "Basic Math",                         rank: 2 },
  { code: "exists",         aliases: ["forsome", "exist"],            symbol: "∃", name: "There exists",                        category: "Basic Math",                         rank: 2 },
  ...
  { code: "vdots",          aliases: [],                              symbol: "⋮", name: "Vertical ellipsis",                   category: "Basic Math",                         rank: 2 },
  { code: "cdots",          aliases: [],                              symbol: "⋯", name: "Midline horizontal ellipsis",          category: "Basic Math",                         rank: 2 },
  { code: "rddots",         aliases: [],                              symbol: "⋰", name: "Upward right diagonal ellipsis",       category: "Basic Math",                         rank: 3 },
  { code: "ddots",          aliases: [],                              symbol: "⋱", name: "Downward right diagonal ellipsis",     category: "Basic Math",                         rank: 2 },
  { code: "overbar",        aliases: ["overline", "vinculum", "repeat", "repeating"], symbol: "¯", name: "Repeating decimal / overline", category: "Basic Math",            rank: 2 },
  { code: "aleph",          aliases: [],                              symbol: "ℵ", name: "Aleph",                               category: "Basic Math",                         rank: 3 },
  { code: "beth",           aliases: [],                              symbol: "ℶ", name: "Beth",                                category: "Basic Math",                         rank: 3 },
  ...
  { code: "doubleE",        aliases: ["expect"],                      symbol: "𝔼", name: "Expected value",                      category: "Statistics and Probability",         rank: 2 },
  { code: "doubleP",        aliases: ["prob"],                        symbol: "ℙ", name: "Probability",                         category: "Statistics and Probability",         rank: 2 },
  ...
  { code: "phi",            aliases: [],                              symbol: "φ", name: "Phi (lowercase)",                     category: "Greek Letters",                      rank: 1 },
  { code: "varphi",         aliases: [],                              symbol: "ϕ", name: "Variant phi",                         category: "Greek Letters",                      rank: 2 },
  ...
  // ── Letter-Like Symbols ───────────────────────────────────────────────────
  { code: "doubleC",        aliases: ["complex"],                     symbol: "ℂ", name: "Complex numbers",                    category: "Letter-Like Symbols",                rank: 2 },
  { code: "doubleN",        aliases: ["naturals"],                    symbol: "ℕ", name: "Natural numbers",                    category: "Letter-Like Symbols",                rank: 2 },
  { code: "doubleQ",        aliases: ["rationals"],                   symbol: "ℚ", name: "Rational numbers",                   category: "Letter-Like Symbols",                rank: 2 },
  { code: "doubleR",        aliases: ["reals"],                       symbol: "ℝ", name: "Real numbers",                       category: "Letter-Like Symbols",                rank: 2 },
  { code: "doubleZ",        aliases: ["integers"],                    symbol: "ℤ", name: "Integers",                           category: "Letter-Like Symbols",                rank: 2 },
  { code: "hbar",           aliases: [],                              symbol: "ℏ", name: "Planck constant over two pi",        category: "Letter-Like Symbols",                rank: 2 },
  { code: "planck",         aliases: [],                              symbol: "ℎ", name: "Planck constant",                    category: "Letter-Like Symbols",                rank: 2 },
  { code: "scriptl",        aliases: [],                              symbol: "ℓ", name: "Script small L",                     category: "Letter-Like Symbols",                rank: 2 },
  { code: "scriptL",        aliases: [],                              symbol: "ℒ", name: "Laplace transform",                  category: "Letter-Like Symbols",                rank: 2 },
  { code: "Im",             aliases: ["frakturI"],                    symbol: "ℑ", name: "Imaginary part",                     category: "Letter-Like Symbols",                rank: 2 },
  { code: "Re",             aliases: ["frakturR"],                    symbol: "ℜ", name: "Real part",                          category: "Letter-Like Symbols",                rank: 2 },
  ...
  { code: "mho",            aliases: [],                              symbol: "℧", name: "Inverted ohm (mho)",                 category: "Letter-Like Symbols",                rank: 3 },
  { code: "AA",             aliases: [],                              symbol: "Å", name: "Angstrom",                           category: "Letter-Like Symbols",                rank: 3 },
  ...
  // ── Binary Operators ───────────────────────────────────────────────
  { code: "ldiv",           aliases: [],                              symbol: "∕", name: "Division slash",                     category: "Binary Operators",                   rank: 2 },
  { code: "circ",           aliases: ["comp"],                        symbol: "∘", name: "Ring operator / composition",        category: "Binary Operators",                   rank: 2 },
  { code: "cdot",           aliases: ["dot"],                         symbol: "⋅", name: "Dot operator",                       category: "Binary Operators",                   rank: 1 },
  { code: "cap",            aliases: ["intersection"],                symbol: "∩", name: "Intersection",                       category: "Binary Operators",                   rank: 2 },
  { code: "cup",            aliases: ["union"],                       symbol: "∪", name: "Union",                              category: "Binary Operators",                   rank: 2 },
  { code: "uplus",          aliases: [],                              symbol: "⊎", name: "Multiset union",                     category: "Binary Operators",                   rank: 3 },
  { code: "sqcap",          aliases: [],                              symbol: "⊓", name: "Square cap",                        category: "Binary Operators",                   rank: 3 },
  { code: "sqcup",          aliases: [],                              symbol: "⊔", name: "Square cup",                        category: "Binary Operators",                   rank: 3 },

  // ── Relational Operators ───────────────────────────────────────────
  { code: "nlt",            aliases: ["notlt"],                       symbol: "≮", name: "Not less than",                      category: "Relational Operators",               rank: 3 },
  { code: "nleq",           aliases: [],                              symbol: "≰", name: "Not less than or equal",             category: "Relational Operators",               rank: 3 },
  { code: "ngt",            aliases: ["notgt"],                       symbol: "≯", name: "Not greater than",                   category: "Relational Operators",               rank: 3 },
  { code: "ngeq",           aliases: [],                              symbol: "≱", name: "Not greater than or equal",          category: "Relational Operators",               rank: 3 },
  { code: "nequiv",         aliases: [],                              symbol: "≢", name: "Not identical to",                   category: "Relational Operators",               rank: 3 },
  { code: "simeq",          aliases: [],                              symbol: "≃", name: "Asymptotically equal to",            category: "Relational Operators",               rank: 2 },
  { code: "nsimeq",         aliases: [],                              symbol: "≄", name: "Not asymptotically equal",           category: "Relational Operators",               rank: 3 },
  { code: "notapprox",      aliases: [],                              symbol: "≉", name: "Not almost equal to",                category: "Relational Operators",               rank: 3 },
  { code: "ncong",          aliases: ["notcong"],                     symbol: "≇", name: "Not congruent to",                   category: "Relational Operators",               rank: 3 },
  { code: "notin",          aliases: [],                              symbol: "∉", name: "Not an element of",                  category: "Relational Operators",               rank: 2 },
  { code: "subset",         aliases: [],                              symbol: "⊂", name: "Subset of",                          category: "Relational Operators",               rank: 2 },
  { code: "supset",         aliases: [],                              symbol: "⊃", name: "Superset of",                        category: "Relational Operators",               rank: 2 },
  { code: "subseteq",       aliases: [],                              symbol: "⊆", name: "Subset of or equal to",              category: "Relational Operators",               rank: 2 },
  { code: "supseteq",       aliases: [],                              symbol: "⊇", name: "Superset of or equal to",            category: "Relational Operators",               rank: 2 },
  { code: "prec",           aliases: [],                              symbol: "≺", name: "Precedes",                           category: "Relational Operators",               rank: 3 },
  { code: "succ",           aliases: [],                              symbol: "≻", name: "Succeeds",                           category: "Relational Operators",               rank: 3 },
  { code: "preceq",         aliases: [],                              symbol: "≼", name: "Precedes or equal to",               category: "Relational Operators",               rank: 3 },
  { code: "succeq",         aliases: [],                              symbol: "≽", name: "Succeeds or equal to",               category: "Relational Operators",               rank: 3 },
  { code: "sqsubset",       aliases: [],                              symbol: "⊏", name: "Square subset",                     category: "Relational Operators",               rank: 3 },
  ...
  { code: "top",            aliases: ["tautology"],                   symbol: "⊤", name: "Tautology (always true)",            category: "Relational Operators",               rank: 2 },
  { code: "bot",            aliases: ["false", "contradiction"],      symbol: "⊥", name: "Contradiction (always false)",       category: "Relational Operators",               rank: 2 },
  { code: "bowtie",         aliases: ["join"],                        symbol: "⋈", name: "Natural join",                       category: "Relational Operators",               rank: 3 },
  { code: "asymp",          aliases: [],                              symbol: "≍", name: "Approximately equal or image of",    category: "Relational Operators",               rank: 3 },

  // ── N-ary Operators ─────────────────────────────────────────────────
  { code: "sum",            aliases: [],                              symbol: "∑", name: "Summation",                          category: "N-ary Operators",                    rank: 1 },
  { code: "prod",           aliases: ["product"],                     symbol: "∏", name: "Product",                            category: "N-ary Operators",                    rank: 2 },
  { code: "amalg",          aliases: ["coprod"],                      symbol: "∐", name: "Coproduct",                          category: "N-ary Operators",                    rank: 3 },
  { code: "int",            aliases: ["integral"],                    symbol: "∫", name: "Integral",                           category: "N-ary Operators",                    rank: 1 },
  { code: "iint",           aliases: ["doubleint"],                   symbol: "∬", name: "Double integral",                    category: "N-ary Operators",                    rank: 2 },
  { code: "iiint",          aliases: ["tripleint"],                   symbol: "∭", name: "Triple integral",                    category: "N-ary Operators",                    rank: 2 },
  { code: "pprime",         aliases: ["dprime", "doubleprime"],       symbol: "″", name: "Double prime",                       category: "N-ary Operators",                    rank: 2 },
  { code: "ppprime",        aliases: ["tprime", "tripleprime"],       symbol: "‴", name: "Triple prime",                       category: "N-ary Operators",                    rank: 3 },
  { code: "pppprime",       aliases: ["qprime", "quadprime"],         symbol: "⁗", name: "Quadruple prime",                    category: "N-ary Operators",                    rank: 3 },
  { code: "oint",           aliases: ["contint"],                     symbol: "∮", name: "Contour integral",                   category: "N-ary Operators",                    rank: 2 },
  { code: "oiint",          aliases: [],                              symbol: "∯", name: "Surface integral",                   category: "N-ary Operators",                    rank: 3 },
  { code: "oiiint",         aliases: [],                              symbol: "∰", name: "Volume integral",                    category: "N-ary Operators",                    rank: 3 },
  { code: "cwint",          aliases: [],                              symbol: "∱", name: "Clockwise integral",                 category: "N-ary Operators",                    rank: 3 },
  { code: "coint",          aliases: [],                              symbol: "∲", name: "Clockwise contour integral",         category: "N-ary Operators",                    rank: 3 },
  { code: "aoint",          aliases: [],                              symbol: "∳", name: "Anticlockwise contour integral",     category: "N-ary Operators",                    rank: 3 },
  { code: "bigcap",         aliases: ["Intersection"],                symbol: "⋂", name: "N-ary intersection",                 category: "N-ary Operators",                    rank: 2 },
  { code: "bigcup",         aliases: ["Union"],                       symbol: "⋃", name: "N-ary union",                        category: "N-ary Operators",                    rank: 2 },
  { code: "bigwedge",       aliases: [],                              symbol: "⋀", name: "N-ary logical AND",                  category: "N-ary Operators",                    rank: 3 },
  { code: "bigvee",         aliases: [],                              symbol: "⋁", name: "N-ary logical OR",                   category: "N-ary Operators",                    rank: 3 },
  { code: "bigodot",        aliases: [],                              symbol: "⨀", name: "N-ary circled dot operator",         category: "N-ary Operators",                    rank: 3 },
  { code: "bigotimes",      aliases: [],                              symbol: "⨂", name: "N-ary circled times operator",       category: "N-ary Operators",                    rank: 3 },
  { code: "biguplus",       aliases: [],                              symbol: "⨄", name: "N-ary union operator with plus",     category: "N-ary Operators",                    rank: 3 },
  { code: "bigcapdot",      aliases: ["bigudot"],                     symbol: "⨃", name: "N-ary intersection with dot",        category: "N-ary Operators",                    rank: 3 },

  // ── Logic / Boolean Operations ────────────────────────────────────────────
  { code: "wedge",          aliases: ["and", "land"],                 symbol: "∧", name: "Logical AND (conjunction)",          category: "Logic / Boolean Operations",         rank: 2 },
  { code: "vee",            aliases: ["or", "lor"],                   symbol: "∨", name: "Logical OR (disjunction)",           category: "Logic / Boolean Operations",         rank: 2 },
  { code: "nand",           aliases: [],                              symbol: "⊼", name: "NAND",                               category: "Logic / Boolean Operations",         rank: 3 },
  { code: "nor",            aliases: [],                              symbol: "⊽", name: "NOR",                                category: "Logic / Boolean Operations",         rank: 3 },
  { code: "oplus",          aliases: ["xor", "directsum"],            symbol: "⊕", name: "Exclusive OR / direct sum (XOR)",   category: "Logic / Boolean Operations",         rank: 2 },
  { code: "odot",           aliases: ["xnor"],                        symbol: "⊙", name: "Exclusive NOR (XNOR)",              category: "Logic / Boolean Operations",         rank: 3 },

  // ── Binary Operators (Advanced) ─────────────────────────────────────────────
  { code: "dotplus",        aliases: [],                              symbol: "∔", name: "Dot plus",                           category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "dotminus",       aliases: [],                              symbol: "∸", name: "Dot minus",                          category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "setminus",       aliases: ["diff"],                        symbol: "∖", name: "Set minus (backslash)",              category: "Binary Operators (Advanced)",        rank: 2 },
  { code: "Cap",            aliases: [],                              symbol: "⋒", name: "Double intersection",                category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "Cup",            aliases: [],                              symbol: "⋓", name: "Double union",                       category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "boxminus",       aliases: [],                              symbol: "⊟", name: "Squared minus",                     category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "boxtimes",       aliases: [],                              symbol: "⊠", name: "Squared times",                     category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "boxdot",         aliases: [],                              symbol: "⊡", name: "Squared dot operator",              category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "boxplus",        aliases: [],                              symbol: "⊞", name: "Squared plus",                      category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "divideontimes",  aliases: [],                              symbol: "⋇", name: "Division times",                    category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "ltimes",         aliases: [],                              symbol: "⋉", name: "Left semidirect product",            category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "rtimes",         aliases: [],                              symbol: "⋊", name: "Right semidirect product",           category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "leftthreetimes", aliases: [],                              symbol: "⋋", name: "Left three times",                  category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "rightthreetimes",aliases: [],                              symbol: "⋌", name: "Right three times",                 category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "curlywedge",     aliases: [],                              symbol: "⋏", name: "Curly logical AND",                  category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "curlyvee",       aliases: [],                              symbol: "⋎", name: "Curly logical OR",                   category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "odash",          aliases: [],                              symbol: "⊝", name: "Circled dash",                      category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "intercal",       aliases: [],                              symbol: "⊺", name: "Intercalate",                       category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "ominus",         aliases: [],                              symbol: "⊖", name: "Circled minus",                     category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "otimes",         aliases: ["tensor", "kron"],              symbol: "⊗", name: "Circled times / tensor product",    category: "Binary Operators (Advanced)",        rank: 2 },
  { code: "oslash",         aliases: [],                              symbol: "⊘", name: "Circled division slash",            category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "oast",           aliases: [],                              symbol: "⊛", name: "Circled asterisk operator",         category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "ocirc",          aliases: [],                              symbol: "⊚", name: "Circled ring operator",             category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "dagger",         aliases: ["dag"],                         symbol: "†", name: "Dagger",                            category: "Binary Operators (Advanced)",        rank: 2 },
  { code: "ddag",           aliases: ["ddagger"],                     symbol: "‡", name: "Double dagger",                     category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "star",           aliases: [],                              symbol: "⋆", name: "Star operator",                     category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "diamond",        aliases: [],                              symbol: "⋄", name: "Diamond operator",                  category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "wr",             aliases: [],                              symbol: "≀", name: "Wreath product",                    category: "Binary Operators (Advanced)",        rank: 3 },
  { code: "bigoplus",       aliases: [],                              symbol: "⨁", name: "N-ary circled plus operator",       category: "Binary Operators (Advanced)",        rank: 2 },
  { code: "bigsqcap",       aliases: [],                              symbol: "⨅", name: "N-ary square intersection",         category: "Binary Operators (Advanced)",        rank: 3 },
  ...
  { code: "geqq",           aliases: [],                              symbol: "≧", name: "Greater than over equal to",         category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "lesssim",        aliases: [],                              symbol: "≲", name: "Less than and similar to",           category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "gtrsim",         aliases: [],                              symbol: "≳", name: "Greater than and similar to",        category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "lessdot",        aliases: [],                              symbol: "⋖", name: "Less than with dot",                 category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "gtrdot",         aliases: [],                              symbol: "⋗", name: "Greater than with dot",              category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "lessgtr",        aliases: [],                              symbol: "≶", name: "Less than or greater than",          category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "lesseqgtr",      aliases: [],                              symbol: "⋚", name: "Less than but not equivalent to",   category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "gtrless",        aliases: [],                              symbol: "≷", name: "Greater than or less than",          category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "gtreqless",      aliases: [],                              symbol: "⋛", name: "Greater than but not equivalent to", category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "Doteq",          aliases: [],                              symbol: "≑", name: "Geometrically equal to",             category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "fallingdotseq",  aliases: [],                              symbol: "≒", name: "Approximately equal or image of",   category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "risingdotseq",   aliases: [],                              symbol: "≓", name: "Image of or approximately equal to", category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "backsim",        aliases: [],                              symbol: "∽", name: "Reversed tilde",                    category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "approxeq",       aliases: [],                              symbol: "≊", name: "Almost equal or equivalent",        category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "backsimeq",      aliases: [],                              symbol: "⋍", name: "Reversed tilde equals",             category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "eqless",         aliases: [],                              symbol: "⋜", name: "Equal to or less than",             category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "eqgtr",          aliases: [],                              symbol: "⋝", name: "Equal to or greater than",          category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "precsim",        aliases: [],                              symbol: "≾", name: "Precedes but not equivalent",       category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "succsim",        aliases: [],                              symbol: "≿", name: "Succeeds or equivalent to",         category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "vartriangleleft",aliases: [],                              symbol: "⊲", name: "Normal subgroup of",               category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "vartriangleright",aliases: [],                             symbol: "⊳", name: "Contains as normal subgroup",      category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "trianglelefteq", aliases: [],                              symbol: "⊴", name: "Normal subgroup or equal",         category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "trianglerighteq",aliases: [],                              symbol: "⊵", name: "Contains as normal subgroup or equal", category: "Relational Operators (Advanced)", rank: 3 },
  { code: "models",         aliases: ["entailment", "true"],          symbol: "⊨", name: "Entailment / models",               category: "Relational Operators (Advanced)",    rank: 2 },
  { code: "Subset",         aliases: [],                              symbol: "⋐", name: "Nested subset",                    category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "Supset",         aliases: [],                              symbol: "⋑", name: "Nested superset",                  category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "vDash",          aliases: ["forces"],                      symbol: "⊩", name: "Forces",                           category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "Vvdash",         aliases: [],                              symbol: "⊪", name: "Triple vertical bar with turnstile", category: "Relational Operators (Advanced)",   rank: 3 },
  { code: "eqcirc",         aliases: [],                              symbol: "≖", name: "Circle with equals sign",          category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "circeq",         aliases: [],                              symbol: "≗", name: "Ring equal to",                    category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "Deltaeq",        aliases: [],                              symbol: "≜", name: "Delta equal to",                   category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "bumpe",          aliases: [],                              symbol: "≏", name: "Difference between",               category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "bumpeq",         aliases: [],                              symbol: "≎", name: "Geometrically equivalent to",      category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "between",        aliases: [],                              symbol: "≬", name: "Between",                          category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "pitchfork",      aliases: [],                              symbol: "⋔", name: "Pitchfork",                        category: "Relational Operators (Advanced)",    rank: 3 },
  { code: "doteq",          aliases: [],                              symbol: "≐", name: "Approaches the limit",             category: "Relational Operators (Advanced)",    rank: 3 },
  ...
  { code: "twoheadrightarrow",aliases: [],                            symbol: "↠", name: "Two-headed right arrow",            category: "Arrows",                             rank: 2 },
  ...
  // ── Negated Relations ─────────────────────────────────────────────────────
  { code: "nsim",           aliases: [],                              symbol: "≁", name: "Not tilde",                          category: "Negated Relations",                  rank: 3 },
  { code: "nasymp",         aliases: [],                              symbol: "≭", name: "Not equivalent to",                  category: "Negated Relations",                  rank: 3 },
  { code: "lneqq",          aliases: [],                              symbol: "≨", name: "Less than but not equal to",         category: "Negated Relations",                  rank: 3 },
  { code: "gneqq",          aliases: [],                              symbol: "≩", name: "Greater than but not equal to",      category: "Negated Relations",                  rank: 3 },
  { code: "nprec",          aliases: [],                              symbol: "⊀", name: "Does not precede",                   category: "Negated Relations",                  rank: 3 },
  { code: "nsucc",          aliases: [],                              symbol: "⊁", name: "Does not succeed",                   category: "Negated Relations",                  rank: 3 },
  { code: "npreceq",        aliases: [],                              symbol: "⋠", name: "Does not precede or equal",          category: "Negated Relations",                  rank: 3 },
  { code: "nsucceq",        aliases: [],                              symbol: "⋡", name: "Does not succeed or equal",          category: "Negated Relations",                  rank: 3 },
  { code: "notni",          aliases: [],                              symbol: "∌", name: "Not contains as member",             category: "Negated Relations",                  rank: 3 },
  { code: "notsubset",      aliases: [],                              symbol: "⊄", name: "Not a subset of",                    category: "Negated Relations",                  rank: 3 },
  { code: "notsuperset",    aliases: [],                              symbol: "⊅", name: "Not a superset of",                  category: "Negated Relations",                  rank: 3 },
  { code: "notsubseteq",    aliases: [],                              symbol: "⊈", name: "Neither subset nor equal",           category: "Negated Relations",                  rank: 3 },
  { code: "notsuperseteq",  aliases: [],                              symbol: "⊉", name: "Neither superset nor equal",         category: "Negated Relations",                  rank: 3 },
